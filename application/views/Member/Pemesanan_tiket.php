                        	...
                        	$no = 1;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if($value->natus == '' or $value == 'null'){

                                        }elseif($value->natus='Tunggu Konfirmasi Admin'){
                                            echo '<p style="color:orange">'.$value->natus.'</p>';
                                        }elseif($value->natus='Di Tolak'){
                                            echo '<p style="color:warning">Bukti Tidak Sesuai</p>';
                                        }
                                        ?>
                                        <!-- <a href="<?php echo base_url('member/updatepemesanantiket/'.$value->idtiket);?>" class="btn btn-info">Upload Bukti</a> -->
                                    </td>
