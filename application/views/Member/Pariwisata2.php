...
$singlebus = explode(',', $value->idbus);
    ...
    if($date > $value->tgl_p){
      ...
      foreach ($singlebus as $keys => $values) {
      
        $this->db->query("update bus set sttb='0' where id = '?'", array($singlebus[$keys]));
                  ...
                  <form action="<?php echo base_url('member/p_pesan');?>" method="post" enctype="multipart/form-data">
                    <table class="table table-responsive">
                      ...
                      <tr>
                        ...
                        <td><div class="col-md-6">
                          <input type="text" name="berangkatdari" readonly="" value="Jember" class="form-control">
                        </div></td>
                      </tr>
                      <tr>
                        <td>Jumlah Sheet</td>
