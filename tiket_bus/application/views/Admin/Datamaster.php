                    ...
                    <form action="<?=base_url('Admin/bus')?>" method="post" enctype="multipart/form-data">
						<table class="table table-responsive">
							<tr>
								...
								<td>
									<div class="col-md-6">
										<select class="form-control" name="status" id="idstatus" onclick="get_namabus()">
											<?php
							...
							<!-- <tr>
								<td>Jumlah Tiket</td>
								<td><div class="col-md-6"><div id="Esheet"></div></div></td>
							</tr> -->
							<tr>
								<td>Sopir</td>
								<td><div class="col-md-6">
						                    ...
						                    <tbody>
						                        ...
						                        foreach ($tabel1 as $key => $value) { ?>
						                            <tr>
						                                ...
						                                <td class="text-right">
						                                    <a href="admin/deletbus/<?php echo $value->idbb;?>" onclick="return konfirmasidelete()" class="btn btn-danger btn-xs" title="Hapus"><b class="glyphicon glyphicon-trash"></b></a>
						                    ...
						                    <tbody>
						                        ...
						                        foreach ($tabel2 as $key => $value) { ?>
						                            <tr>
						                                ...
						                                <td><?php echo $value->berangkat.' WIB'?></td>
